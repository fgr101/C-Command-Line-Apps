...
void ChangeMasterKey() {
	...
	printf("Enter NEW MASTER KEY: ");
	scanf("%49s", &UserInput0);
	printf("Re-enter NEW MASTER KEY: ");
	scanf("%49s", &UserInput1);
...
// - MENU Section --> MANAGE PASSWORDS [OK].
// - Different parts of the program reorganized in specific functions.

// Version 0.2

// - Delete ALL passwords - FINISHED [100%]
